...
plot(y, type="l", main="Average Daily Activity Pattern", cex.main=.75, cex.lab=.75, cex.axis=.6, ylab="Number of Steps", xlab="Interval")
```
...
for (i in 1:nrow(NewData2)){
  if (is.na(NewData2$steps[i])){
    ...
    #print (date_Value)
    #indexing <- subset(date_steps, date_steps == date_Value)
...
for (i in 1:nrow(NewData2)){
        ...
        else {NewData2$dayType2[i] <- "Weekday"}
}
...
plot(k, type="l", main="Weekends", cex.main=.75, cex.lab=.75, cex.axis=.6, ylab="Number of Steps", xlab="")
plot(j, type="l", main="Weekdays", cex.main=.75, cex.lab=.75, cex.axis=.6, xlab="Interval", ylab="Number of Steps")
```
